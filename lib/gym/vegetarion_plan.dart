...
class Vegetarian_detail extends StatefulWidget {
  const Vegetarian_detail({Key? key}) : super(key: key);

  @override
  State<Vegetarian_detail> createState() => _Vegetarian_detailState();
}

class _Vegetarian_detailState extends State<Vegetarian_detail>  with TickerProviderStateMixin{
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("Vegetable Based Plan",style: GoogleFonts.poppins(
                            color: Colors.white,
                            fontSize: 22,
                            fontWeight: FontWeight.bold
                        ),),
